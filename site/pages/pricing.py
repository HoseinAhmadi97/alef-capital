...
<div class="wrap">
  ...
  <div class="faq">
    <details open><summary>آیا می‌توانم قبل از خرید، داشبورد را ببینم؟</summary><p>بله. صفحه <a href="market.html">نبض بازار</a> و داشبورد طلا بدون ثبت‌نام باز هستند و داده لحظه‌ای همه صندوق‌ها را نشان می‌دهند. خارج از ساعات معاملاتی هم داده کامل آخرین روز معاملاتی برای همه در دسترس است.</p></details>
