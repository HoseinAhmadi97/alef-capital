...
<div class="wrap">
  <div class="wcat" style="grid-template-columns:2fr 1fr">
    ...
    <div class="wc" style="background:var(--band);border-color:var(--band)">
      <span class="ic">🧮</span>
...
<div class="wrap" style="max-width:880px">
  ...
  <div class="faq" style="margin:0 0 40px">
    ...
    <details><summary>تأخیر داده چقدر است؟</summary><p>داده صندوق‌های طلا و دارایی‌های پایه برای همه کاربران لحظه‌ای است و هر چند ثانیه به‌روز می‌شود. مهر زمان آخرین به‌روزرسانی همیشه روی صفحه نمایش داده می‌شود.</p></details>
